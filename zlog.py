...
parser.add_argument('-c', '--cpu', action='store_true',
   help="checks for high CPU usage in logs")
...
if args.cpu:
   ...
   #with open(saveplace + "zLog.cpu.log") as f:
      #contents = f.readlines()
      #for line in reversed(contents):
         #line = line.replace("\n", "")
         #linelist = line.split() #splits line from file into a list with space delimeter
         #cpu = linelist[0]
         #req_time = linelist[1]
